...
#
# # from src.utils import connect_to_data_base
#
#
...
# driver = webdriver.Chrome('chromedriver/chromedriver_win.exe')
# ## wait for driver loaded completely
# driver.implicitly_wait(30)
# ## get page
# driver.get("https://datalab.naver.com/")
#
# cates = ['패션의류', '패션잡화', '화장품/미용', '디지털/가전', '가구/인테리어', '출산/육아', '식품', '스포츠/레저', '생활/건강', '여행/문화', '면세점']
# ### define tags to get data
